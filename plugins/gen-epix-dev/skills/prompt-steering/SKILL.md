---
name: prompt-steering
description: 'Use when creating or refining prompts for coding, debugging, refactoring, or review tasks. Steer GitHub Copilot Chat in VS Code toward reliable outputs. Produces copy/paste-ready prompt templates with goal, constraints, context pinning, definition of done, and verification plan.'
